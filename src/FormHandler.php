...
class FormHandler
{
	...
	public function __construct()
	{
		...
		$this->mailer->Subject = "Vaultavo Website Contact Us Form Submission ";

		$host = isset($_SERVER['SERVER_NAME'])?$_SERVER['SERVER_NAME']:'localhost';
        $from_email ='website@vaultavo.com';
	...
	public function process($post_data)
	{
		...
		if($this->validator->hasErrors())
		{
			...
			$errs = $this->validator->getErrors(/*associative*/ true);
			foreach($errs as $field_name => $msg) {
				switch (strtolower($field_name)) {
					case "yourfname":
						$errs[$field_name] =  str_replace($field_name, 'Your First Name', $msg);
						break;
					case "yourlname":
						$errs[$field_name] =  str_replace($field_name, 'Your Last Name', $msg);
						break;
					case "youremail":
						$errs[$field_name] =  str_replace($field_name, 'Your Email', $msg);
						break;
					case "yourtelephone":
						$errs[$field_name] =  str_replace($field_name, 'Your Telephone Number', $msg);
						break;	
					case "yourmessage":
						$errs[$field_name] =  str_replace($field_name, 'Your Message', $msg);
						break;	
				}
        	}  
	...
	{
		$content = "Hi,\n\nThere has been a Vaultavo Website Contact Us submission: \n\n";
		$content .= "-------------------------------------------------------------- \n\n";
